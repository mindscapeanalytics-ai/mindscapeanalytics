                ...
                <header className="py-24 mb-16 relative overflow-hidden text-center rounded-[4rem] border border-border bg-foreground/[0.01] backdrop-blur-[2px] institutional-grid">
                    ...
                    <div className="relative z-10 max-w-4xl mx-auto px-6">
                        ...
                        >
                            ...
                            <p className="text-xl md:text-2xl lg:text-3xl font-black text-foreground/40 font-sans tracking-tight leading-[1.1] md:leading-[1] uppercase text-center max-w-4xl mx-auto">
