...
export default function PayoutForm({ initialMethod, initialDetails }: PayoutFormProps) {
    ...
    return (
        <form action={formAction} className="space-y-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    {[
                        ...
                        >
                            ...
                            <div className="text-[9px] text-white/30 uppercase tracking-widest mt-1">{method.description}</div>
            ...
            <div className="space-y-3">
                <label className="text-[10px] font-black uppercase tracking-[0.2em] text-white/20 ml-1">Destination Address / ID</label>
                <input
                    type="text"
                    name="payoutDetails"
                    ...
                    className="w-full px-6 py-5 bg-white/[0.03] border border-white/5 rounded-2xl text-white placeholder:text-white/10 focus:outline-none focus:border-white/20 focus:bg-white/[0.05] transition-all font-mono text-sm tracking-widest"
                />
            </div>
            ...
            <div className="pt-4">
                <button
                    type="submit"
                    disabled={isPending}
                    className="w-full py-5 bg-white text-black rounded-2xl font-black text-[10px] uppercase tracking-[0.3em] hover:bg-white/90 transition-all flex items-center justify-center gap-4 disabled:opacity-50"
                >
                    {isPending ? (
