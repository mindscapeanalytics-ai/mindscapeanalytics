    ...
    return (
        <div className="space-y-12">
            <div>
                ...
                <p className="text-foreground/40 font-medium uppercase tracking-widest text-sm">{isSeller ? "Vendor Analytics & Listings" : "Platform Overview & Analytics"}</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {stats.map((stat) => (
                    <div key={stat.label} className="p-8 rounded-3xl bg-foreground/[0.02] border border-border hover:border-border transition-all group card-premium">
                        ...
                        <h3 className="text-foreground/40 text-xs font-black uppercase tracking-widest mb-1">{stat.label}</h3>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div className="p-8 rounded-3xl bg-foreground/[0.02] border border-border backdrop-blur-md">
                    <div className="flex items-center justify-between mb-8">
                        <h3 className="text-xl font-bold uppercase tracking-tight">Recent Activity</h3>
                        <button className="text-foreground/40 text-[10px] font-black uppercase tracking-widest hover:text-foreground transition underline underline-offset-4 decoration-white/10">View All</button>
                    </div>
                ...
                <div className="p-8 rounded-3xl bg-foreground/[0.02] border border-border backdrop-blur-md">
                    <div className="flex items-center justify-between mb-8">
                        ...
                        <div className="px-3 py-1 bg-foreground/5 text-foreground/60 text-[10px] font-black uppercase tracking-widest rounded-full border border-border">
                            Healthy
                        </div>
                    </div>
                    <div className="space-y-4">
                        <div className="flex justify-between items-center text-sm">
                            <span className="text-foreground/40 font-medium uppercase tracking-wider text-xs">Database</span>
                            <span className="font-bold text-green-400">Connected</span>
                        </div>
                        <div className="flex justify-between items-center text-sm">
                            <span className="text-foreground/40 font-medium uppercase tracking-wider text-xs">Authentication</span>
                            <span className="font-bold text-green-400">Ready</span>
                        </div>
                        <div className="flex justify-between items-center text-sm">
                            <span className="text-foreground/40 font-medium uppercase tracking-wider text-xs">Stripe API</span>
