                ...
                <div className="container mx-auto px-6 max-w-7xl">
                    <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                        ...
                        <ScrollReveal className="p-8 sm:p-12 rounded-[2rem] sm:rounded-[3rem] bg-foreground/[0.02] border border-foreground/10 backdrop-blur-xl relative overflow-hidden group shadow-2xl">
                            ...
                            <h3 className="text-lg sm:text-xl font-black uppercase text-foreground mb-8 tracking-tight font-sans">What Makes Us Different?</h3>
                            <div className="space-y-6">
                        ...
                        {expertise.map((exp, index) => (
                            ...
                            >
                                ...
                                <div className="space-y-4">
                                    ...
                                    <h3 className="text-lg font-black text-foreground uppercase tracking-tight font-sans">{exp.title}</h3>
                            ...
                            >
                                <div>
                                    ...
                                    <div className="space-y-4">
                                        <div className="flex justify-between items-start">
                                            <div>
                                                <h3 className="text-xl font-black uppercase font-sans tracking-tighter text-foreground">{member.name}</h3>
                                ...
                                >
                                    ...
                                    <div className="w-full md:w-1/2 pl-12 md:pl-0 md:px-12">
                                        <div className={`space-y-4 p-8 rounded-2xl bg-foreground/[0.02] border border-foreground/5 hover:border-foreground/10 transition-colors backdrop-blur-xl relative ${index % 2 === 0 ? 'md:text-left' : 'md:text-right'}`}>
                                            <span className="text-4xl sm:text-5xl font-black text-foreground/10 font-sans leading-none absolute top-4 right-6 pointer-events-none">{item.year}</span>
                                            <span className="text-3xl sm:text-4xl font-black text-foreground font-sans leading-none block">{item.year}</span>
                ...
                <div className="container mx-auto px-6 max-w-7xl">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-12 sm:gap-16">
                        {[
                            ...
                            >
                                <div className="text-5xl sm:text-6xl md:text-7xl font-black mb-4 text-foreground font-sans leading-none tracking-tighter group-hover:scale-105 transition-transform duration-500">
                                    {stat.value}
                                </div>
