                ...
                >
                    ...
                    <div className="space-y-8 text-white/60 font-medium uppercase tracking-tight leading-relaxed">
                        <section className="space-y-4">
                            <h2 className="text-white text-xl font-black tracking-widest border-l-2 border-white/20 pl-4">SERVICE_PROVISION // 01</h2>
                        ...
                        <section className="space-y-4">
                            <h2 className="text-white text-xl font-black tracking-widest border-l-2 border-white/20 pl-4">INTELLECTUAL_CORE // 02</h2>
                        ...
                        <section className="space-y-4">
                            <h2 className="text-white text-xl font-black tracking-widest border-l-2 border-white/20 pl-4">LIABILITY_BOUNDS // 03</h2>
