        ...
        <div className="min-h-screen bg-transparent text-white selection:bg-white selection:text-black">
            ...
            <main className="pt-32 pb-24 px-6">
                <div className="max-w-4xl mx-auto">
                    {/* Header */}
                    <div className="mb-20 border-b border-white/5 pb-12 text-center">
                        <motion.div
                        ...
                        >
                            ...
                            <span className="text-xs font-mono text-white/40 uppercase tracking-[0.5em]">Legal // Protocol_0.9</span>
                        </motion.div>
                        <motion.h1
                            initial={{ opacity: 0, y: 20 }}
                            animate={{ opacity: 1, y: 0 }}
                        ...
                        >
                            SELLER <span className="text-white/30 italic">POLICY.</span>
                        </motion.h1>
                    </div>
                    ...
                    <div className="space-y-16">
                        ...
                        <section className="space-y-6">
                            ...
                            <div className="bg-white/5 border border-white/10 rounded-2xl p-8 space-y-4 leading-relaxed text-white/60 font-medium">
                                <p>
                                ...
                                <div className="p-6 rounded-xl bg-white text-black font-black text-center text-3xl tracking-tighter uppercase">
                                    10% PLATFORM FEE
                                </div>
                        ...
                        <section className="space-y-6">
                            <div className="flex items-center gap-4 border-l-2 border-white/40 pl-6">
                                ...
                                <h2 className="text-2xl font-black uppercase tracking-tight text-white/80">02. Elite Quality Protocol</h2>
                            </div>
                            <div className="space-y-4 text-white/50 leading-relaxed font-medium">
                                ...
                                <ul className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    {[
                                        ...
                                        <li key={i} className="flex items-center gap-3 p-4 rounded-xl bg-white/[0.03] border border-white/5 text-xs font-mono uppercase tracking-widest">
                        ...
                        {/* 3. Payouts */}
                        <section className="space-y-6">
                            <div className="flex items-center gap-4 border-l-2 border-white/20 pl-6">
                                <Zap className="w-5 h-5 text-white/20" />
                                <h2 className="text-2xl font-black uppercase tracking-tight text-white/60">03. Financial Settlement</h2>
                            </div>
                        ...
                        {/* 4. Contact Policy */}
                        <section className="mt-12 p-8 rounded-3xl bg-gradient-to-br from-zinc-900 to-black border border-white/10 text-center">
                            ...
                            <a href="mailto:info@mindscapeanalytics.com">
                                <button className="px-8 py-4 bg-white text-black font-black uppercase text-xs tracking-widest rounded-xl hover:bg-white/90 transition-all">
                                    Consult Seller Desk
                                </button>
                            </a>
                        </section>
