...
export default async function SellerDashboard() {
    ...
    if (!isSeller) {
        return (
            <div className="min-h-screen bg-monochrome-cinematic text-foreground flex items-center justify-center p-6 relative">
                <div className="fixed inset-0 z-0 pointer-events-none opacity-20">
                    <div className="absolute inset-0 bg-[url('/grid.svg')] bg-center [mask-image:radial-gradient(ellipse_at_center,transparent_20%,black)]" />
                </div>
                <div className="text-center max-w-md relative z-10">
                    <div className="inline-block p-4 bg-foreground/5 border border-border rounded-2xl mb-8">
                        <Package size={48} className="text-foreground/20 animate-pulse" />
                    </div>
                    <h1
                    ...
                    <Link href="/become-seller">
                        <button className="w-full py-5 bg-foreground text-background rounded-2xl font-black text-[10px] uppercase tracking-[0.4em] hover:bg-foreground/90 transition-all active:scale-95 shadow-2xl">
