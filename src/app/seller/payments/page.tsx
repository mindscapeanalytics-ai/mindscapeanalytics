...
export default async function SellerPaymentsPage() {
    ...
    if (!session?.user) {
        redirect("/sign-in?callbackUrl=/seller/payments");
    }
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="mb-16">
                        <div className="inline-flex items-center gap-3 px-3 py-1 bg-white/5 border border-white/10 rounded-full mb-6">
                            ...
                            <span className="text-[9px] font-black uppercase tracking-[0.3em] text-white/40">Settlement Protocol v1.0</span>
                        </div>
                        <h1
                            className="text-6xl font-black mb-6 uppercase tracking-tighter italic"
                            style={{ fontSize: "clamp(3rem, 8vw, 5rem)" }}
                        >
                            PAYOUT <span className="text-white/20 not-italic">CONFIGURATION.</span>
                        </h1>
                        <p className="text-white/40 text-[11px] font-black uppercase tracking-[0.5em] italic leading-loose max-w-2xl">
