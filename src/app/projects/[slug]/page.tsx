            ...
            <section className="relative pt-48 pb-24 overflow-hidden">
                <div className="container mx-auto px-6 relative z-10">
                    <div className="max-w-5xl mx-auto space-y-8">
                        ...
                        <h1
                            className="text-5xl md:text-7xl lg:text-8xl font-black font-syncopate uppercase tracking-[-0.02em] leading-[0.9]"
            ...
            <section className="py-32 bg-foreground text-background text-center">
                <div className="container mx-auto px-6">
                    <div className="max-w-3xl mx-auto space-y-8">
                        ...
                        <h2 className="text-5xl font-black font-syncopate uppercase tracking-[-0.03em] leading-tight">
