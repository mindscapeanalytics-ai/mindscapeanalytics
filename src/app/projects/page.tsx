            ...
            <section className="relative pt-44 pb-16 overflow-hidden">
                <div className="container-standard relative z-10 text-center space-y-12">
                    ...
                    >
                        ...
                        <span className="text-white/60 text-[9px] font-mono font-black tracking-[0.5em] uppercase leading-none mt-0.5">Deployment_Logs // v5.1</span>
                    </motion.div>
                                ...
                                <div className="relative z-10 grid lg:grid-cols-2 gap-12 lg:gap-20">
                                    <div className="space-y-8 flex flex-col justify-center">
                                        <div className="space-y-4">
                                            <div className="flex flex-wrap gap-2">
                                                <span className="px-3 py-1 bg-white/5 border border-white/10 rounded-full text-[9px] font-mono font-black uppercase tracking-widest text-white/60">
                                                    {project.category}
                                                </span>
                                                <span className="px-3 py-1 bg-white/5 border border-white/10 rounded-full text-[9px] font-mono font-black uppercase tracking-widest text-white/40">
                                    ...
                                    <div className="space-y-10 flex flex-col justify-center bg-white/[0.01] p-8 rounded-3xl border border-white/5">
                                        ...
                                        <Link href={project.link} className="inline-block mt-4">
                                            <button className="flex items-center justify-center w-full gap-4 px-8 py-5 bg-white text-black font-black uppercase text-[10px] tracking-[0.4em] rounded-xl hover:scale-[1.02] transition-transform">
                                                View Case Study
                ...
                <div className="container-standard">
                    <div className="max-w-4xl mx-auto space-y-8">
                        ...
                        <Link href="/pricing" className="inline-block pt-8">
                            <button className="flex items-center gap-4 px-12 py-6 bg-black text-white font-black uppercase text-[10px] tracking-[0.4em] rounded-xl hover:scale-[1.02] transition-transform mx-auto">
                                View Pricing & SLAs
