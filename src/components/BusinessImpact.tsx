                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-px bg-foreground/5 border border-border overflow-hidden">
                    {impacts.map((impact, i) => (
                        ...
                        >
                            ...
                            <motion.div
                                className="text-5xl md:text-6xl lg:text-[min(5.5vw,5.5rem)] font-black text-foreground mb-4 tracking-[-0.05em] font-sans uppercase leading-[0.85] group-hover:scale-105 transition-transform duration-1000"
                            >
                                {impact.value}
                            </motion.div>
