                    ...
                    {steps.map((step, index) => (
                        ...
                        >
                            ...
                            <div className="flex items-center justify-between mb-12">
                                <span className="text-5xl font-black text-foreground/5 group-hover:text-foreground/20 transition-all duration-500 font-sans leading-none tracking-[-0.05em]">
                                    {step.number}
                                </span>
                            ...
                            <h3 className="text-xl md:text-[min(1.3vw,1.35rem)] font-black text-foreground/80 mb-6 uppercase tracking-[-0.05em] group-hover:text-foreground transition-colors font-sans leading-tight break-words">
                                {step.title}
                            </h3>
