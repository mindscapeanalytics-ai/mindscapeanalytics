...
export default function Products() {
    return (
        <section id="products" className="relative pt-0 pb-32 px-6 overflow-hidden bg-transparent text-white">
                                ...
                                <div className="flex flex-col h-full relative z-10">
                                    <div className="flex items-start justify-between mb-16">
                                        ...
                                        <div className="flex flex-col items-end">
                                            <span className="text-meta text-white/40 mb-1">Status // DEPLOYED</span>
                                            <span className="text-meta text-white/10">{product.tag}</span>
                                        </div>
                                    </div>
