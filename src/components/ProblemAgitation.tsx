            ...
            <div className="container-standard">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                    <div className="flex flex-col items-center lg:items-start max-w-4xl space-y-6">
                        ...
                        >
                            THE COST OF <br className="hidden md:block" /> <span className="text-secondary font-black drop-shadow-[0_0_15px_rgba(var(--secondary),0.4)]">INEFFICIENCY.</span>
                        </motion.h2>
                        <motion.p
                            initial={{ opacity: 0, y: 15 }}
                            animate={{ opacity: 1, y: 0 }}
                        ...
                        <div className="relative grid grid-cols-1 gap-4">
                             {painPoints.map((point, i) => (
                                ...
                                >
                                    ...
                                    <div className="w-1.5 h-1.5 rounded-full bg-foreground/10 group-hover:bg-secondary transition-all shadow-[0_0_10px_rgba(var(--secondary),0)] group-hover:shadow-[0_0_15px_rgba(var(--secondary),0.6)]" />
                                </motion.div>
                            ))}
                            ...
                            >
                                ...
                                <p className="text-4xl md:text-5xl font-black uppercase tracking-[-0.05em] font-sans leading-none text-background">YOU NEED AN <br /> <span className="text-secondary drop-shadow-[0_0_20px_rgba(var(--secondary),0.3)]">INTELLIGENT SYSTEM.</span></p>
