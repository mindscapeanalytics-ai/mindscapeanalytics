                    ...
                    <div className="relative">
                        ...
                        <div className="relative grid grid-cols-1 gap-4">
                            ...
                            >
                                ...
                                <p className="text-4xl md:text-5xl font-black uppercase tracking-[-0.05em] font-sans leading-none text-background">YOU NEED AN <br /> <span className="text-secondary drop-shadow-[0_0_20px_hsl(var(--secondary) / 0.3)]">INTELLIGENT SYSTEM.</span></p>
