    ...
    return (
        <div className="relative z-50">
            <button
                ...
                className="flex items-center gap-2 px-4 py-2 bg-white/5 border border-white/10 rounded-xl hover:bg-white/10 hover:border-white/20 transition-all font-mono text-[10px] uppercase font-black tracking-widest text-white/80"
            >
                ...
                {isOpen && (
                    <>
                        ...
                        <motion.div
                            ...
                            className="absolute right-0 mt-3 w-80 bg-zinc-900/95 backdrop-blur-3xl border border-white/10 rounded-2xl shadow-[0_20px_40px_rgba(0,0,0,0.8)] z-50 overflow-hidden"
                        >
                            <div className="p-4 border-b border-white/5 flex items-center justify-between">
                                <span className="text-[10px] font-black uppercase tracking-[0.3em] text-white/60">Wallet Integration</span>
                                <span className="text-[8px] font-mono text-white/20 uppercase tracking-widest">Web3_Link</span>
                            </div>
                                ...
                                {!walletAddress ? (
                                    <>
                                        <button
                                            ...
                                            className="w-full flex items-center justify-between p-4 bg-white/[0.03] border border-white/5 rounded-xl hover:bg-white/[0.08] transition-all group disabled:opacity-50"
                                        >
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div className="text-left">
                                                    <div className="text-[11px] font-black uppercase tracking-widest text-white">Ethereum (ETH)</div>
                                                    <div className="text-[9px] font-medium uppercase tracking-widest text-white/40">MetaMask / ERC-20</div>
                                                </div>
                                            </div>
                                            {isConnecting && !error ? <RefreshCw className="w-4 h-4 animate-spin text-white/40" /> : null}
                                        </button>
                                        ...
                                        >
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div className="text-left">
                                                    <div className="text-[11px] font-black uppercase tracking-widest text-white">Solana (SOL)</div>
                                                    <div className="text-[9px] font-medium uppercase tracking-widest text-white/40">Phantom / SPL</div>
                                                </div>
                                            </div>
                                            {isConnecting && !error ? <RefreshCw className="w-4 h-4 animate-spin text-white/40" /> : null}
                                        </button>
                                    ...
                                    <div className="space-y-4">
                                        <div className="p-4 bg-white/5 border border-white/10 rounded-xl space-y-3">
                                            ...
                                            <div className="flex items-center justify-between">
                                                <span className="text-[9px] font-black uppercase tracking-widest text-white/40">Address</span>
                                                <span className="text-[11px] font-mono text-white tracking-widest">{formatAddress(walletAddress)}</span>
                                            </div>
