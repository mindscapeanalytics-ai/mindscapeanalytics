...
export function AdminSidebar({ navItems }: AdminSidebarProps) {
    ...
    return (
        <>
            {/* Mobile Header */}
            <header className="lg:hidden flex items-center justify-between p-4 border-b border-white/10 bg-black/40 backdrop-blur-xl sticky top-0 z-50">
                <Image
            ...
            {/* Sidebar Overlay */}
            <aside className={cn(
                "fixed inset-y-0 left-0 z-[100] w-72 border-r border-white/10 p-8 flex flex-col backdrop-blur-2xl bg-black/90 lg:bg-white/[0.02] lg:sticky lg:h-screen transition-transform duration-500",
