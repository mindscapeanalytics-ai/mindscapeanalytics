                        ...
                        <div className="flex items-center justify-between px-5 py-4 border-b border-border bg-foreground/[0.02]">
                            ...
                            <div className="flex items-center gap-1.5">
                                <button
                                    ...
                                    className={cn(
                                        "w-8 h-8 rounded-lg flex items-center justify-center transition-all relative group/hud",
                                        isHudOpen ? "bg-secondary/10 text-secondary" : "hover:bg-foreground/5 text-foreground/40 hover:text-foreground/80"
                                    )}
                                    title="Toggle Operational HUD"
                                >
