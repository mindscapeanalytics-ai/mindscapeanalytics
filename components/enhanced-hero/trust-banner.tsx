...
export function TrustBanner({ config, fullWidth = true, className }: TrustBannerProps) {
  ...
  return (
    <motion.div
      className={`relative w-full ${visualIntegration
      ...
      >
        <div className="flex flex-col lg:flex-row justify-between items-center gap-4 w-full">
          ...
          <div className="flex flex-wrap items-center gap-4 lg:gap-6">
            ...
            {statusIndicators.map((indicator, index) => (
              <div key={index} className="flex items-center gap-2">
                <div className={`w-2 h-2 rounded-full ${indicator.status === 'online' ? 'bg-green-400 animate-pulse shadow-lg shadow-green-400/50' :
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <Card className={`${visualIntegration
