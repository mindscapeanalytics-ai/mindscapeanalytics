...
if (typeof document !== 'undefined' && typeof window !== 'undefined') {
  ...
  if (!document.querySelector('#heartbeat-styles')) {
    const styleElement = document.createElement('style');
    styleElement.id = 'heartbeat-styles';
...
export default function RadialOrbitalTimeline({
  ...
  return (
    <div
      className="w-full h-full flex flex-col items-center justify-start bg-transparent overflow-hidden mt-0 md:-mt-24"
      ref={containerRef}
    ...
    >
      <div className="relative w-full max-w-4xl h-full flex items-center justify-center">
        ...
        >
          {/* Central Hub with Brand Logo - Enhanced & Larger */}
          <div className="absolute flex items-center justify-center z-10">
            {/* Subtle ping rings for ambient effect - adjusted for larger logo */}
            <div className="absolute w-40 h-40 rounded-full border border-white/5 animate-ping opacity-30"></div>
            <div
              className="absolute w-52 h-52 rounded-full border border-white/3 animate-ping opacity-20"
              style={{ animationDelay: "0.5s" }}
            ></div>
            <div
              className="absolute w-64 h-64 rounded-full border border-white/2 animate-ping opacity-10"
